...
//edit by ligang 2017/8/23
func (s * SendTx)GetSigners()([]crypto.PubKey){
	return s.signers
}
func (s * SendTx)SetSigners(signer []crypto.PubKey)(){
	s.signers = signer
}
func (s * SendTx)GetChainId()(string){
	return 	s.chainID
}
func (s*SendTx)SetChianId(chainId string){
	s.chainID = chainId
}
